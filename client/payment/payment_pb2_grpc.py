...
class PaymentStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Purchase = channel.unary_unary(
                '/Payment/Purchase',
                request_serializer=payment__pb2.PurchaseRequest.SerializeToString,
...
def add_PaymentServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Purchase': grpc.unary_unary_rpc_method_handler(
                    servicer.Purchase,
                    request_deserializer=payment__pb2.PurchaseRequest.FromString,
...
class Payment(object):
    ...
    def Purchase(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Payment/Purchase',
            payment__pb2.PurchaseRequest.SerializeToString,

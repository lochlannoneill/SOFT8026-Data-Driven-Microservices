...
class UserStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetDetails = channel.unary_unary(
                '/User/GetDetails',
                request_serializer=user__pb2.GetDetailsRequest.SerializeToString,
                response_deserializer=user__pb2.GetDetailsResponse.FromString,
                )
...
def add_UserServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetDetails': grpc.unary_unary_rpc_method_handler(
                    servicer.GetDetails,
                    request_deserializer=user__pb2.GetDetailsRequest.FromString,
                    response_serializer=user__pb2.GetDetailsResponse.SerializeToString,
            ),
    }
...
class User(object):
    ...
    def GetDetails(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/User/GetDetails',
            user__pb2.GetDetailsRequest.SerializeToString,
            user__pb2.GetDetailsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
